...
st.set_page_config(page_title="중력 렌즈 시뮬레이터 (공전 궤도 + 관측자 뒤)", layout="centered")
st.title("🔭 중력 렌즈 효과 시뮬레이터 (렌즈 공전 + 관측자 궤도 뒤 고정)")
...
# 관측자 위치를 궤도 중심에서 뒤로 멀리 배치 (예: y = -orbit_radius - 20)
